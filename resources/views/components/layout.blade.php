            ...
            <div class="flex items-center">
                ...
                <ul class="flex text-xl gap-10 mr-24">
                    ...
                    @auth
                        ...
                        <li
                            class="{{ request()->is('admin/company/create') ? 'hidden' : '' }} {{ $user->hasRole('admin') ? '' : 'hidden' }} ">
                            <a href="{{ route('admin.company.create') }}" class="navElement"> Create a Company</a>
                        </li>
                        <li
                            class="{{ request()->is('admin/company/index') ? 'hidden' : '' }} {{ $user->hasRole('admin') ? '' : 'hidden' }} ">
                            <a href="{{ route('admin.company.index') }}" class="navElement">Company List</a>
                        </li>
                        <li>
