...
@endif
    ...
    <x-card-base>
        <div class="flex flex-col gap-5">
            ...
            <a href="{{ route('companyLead.projects.user',$user)}}" class="btn-primary text-center">Contact Owner</a>
            @endif
        </div>
        
        
        
        @if ($project->user_id === Auth::id() ||  Auth::user()->hasRole('admin') || Auth::user()->hasRole('companyLead'))
